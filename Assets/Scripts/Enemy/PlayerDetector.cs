...
namespace HomeByMarch
{
    public class PlayerDetector : MonoBehaviour
    {
        ...
        [SerializeField] public float attackRange = 3f; // Distance from enemy to player to attack
        ...
        public bool CanAttackPlayer()
        {
            ...
            //Debug.Log($"[CanAttackPlayer] Distance to player: {distance:F2} | Required: {attackRange}");
